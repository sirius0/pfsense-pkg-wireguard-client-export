...
WGCE_SOURCE_ROOT=${1:-}
WGCE_OUTPUT_DIR=${2:-}
WGCE_VERSION=${WGCE_PACKAGE_VERSION:-${WGCE_TEST_VERSION:-0.1.0.b2}}
...
if ! pkg info -e 'pfSense-pkg-WireGuard-0.2.13_4'; then
	echo 'The package builder requires pfSense-pkg-WireGuard-0.2.13_4.' >&2
	exit 69
fi
